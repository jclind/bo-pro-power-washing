        ...
        <div className={styles.content}>
          ...
          <div className={styles.text_section}>
            ...
            <p className='section-text text-inverted'>
              ...
              business because I love helping people take pride in their homes.
              Whether it's a driveway covered in dirt or siding that needs a
              refresh, I’m here to bring your property back to life with
